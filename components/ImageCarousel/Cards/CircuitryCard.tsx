...
const CircuitryCard: React.FC<props> = ({ className = " " }) => {
  return (
    <div
      className={`light text-textColor w-[960px] min-w-[960px] max-w-[960px] h-[550px] min-h-[550px] max-h-[550px] mx-auto rounded-2xl shadow-2xl drop-shadow-2xl mb-4 transition-all duration-300 px-16 ${className} `}
    >
